...
function TabsList({
  ...
  return (
    <div
      ...
      className='-mx-1 w-full max-w-full min-w-0 touch-pan-x overflow-x-auto overflow-y-hidden overscroll-x-contain px-1 pb-1 [scrollbar-gutter:stable]'
    >
      <TabsPrimitive.List
        data-slot='tabs-list'
        className={cn(
          'bg-muted text-muted-foreground inline-flex h-9 w-max min-w-min items-center justify-start rounded-lg p-[3px]',
          className
        )}
        {...props}
      />

    ...
    "paths": {
        ...
        "/auth/sso/callback": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to app after OIDC callback"
                    }
                }
            }
        },
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "402": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.QuotaExceededError"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/platform/integrations/sms/test": {
            "post": {
                ...
                "operationId": "testSMSIntegration",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.TestSMSIntegrationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tickets/{id}/cancel": {
            "post": {
                ...
                "operationId": "visitorCancelTicket",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Ticket ID",
                    ...
                    {
                        "type": "string",
                        "description": "Visitor ownership token",
        ...
        "/tickets/{id}/phone": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Phone opt-in request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AttachPhoneRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Ticket no longer in waiting state",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/units/{unitId}/operator-skills": {
            "get": {
                ...
                "operationId": "listUnitOperatorSkills",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.OperatorSkill"
                            }
                        }
                    },
                    "401": {
            ...
            "put": {
                ...
                "operationId": "upsertUnitOperatorSkills",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                    ...
                    {
                        "description": "Skills to upsert",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.bulkUpsertSkillsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/units/{unitId}/operator-skills/{skillId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "deleteUnitOperatorSkill",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
        ...
        "/units/{unitId}/queue-status": {
            "get": {
                ...
                "operationId": "getUnitQueueStatus",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Unit ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.UnitQueueSummary"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/units/{unitId}/statistics/export/pdf": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "exportStatisticsPDF",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                    ...
                    {
                        "type": "string",
                        "description": "Filter by operator/user ID (exact match)",
                        "name": "userId",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by service zone ID (exact match)",
                        "name": "serviceZoneId",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter survey scores by survey definition ID",
                        "name": "surveyId",
                        "in": "query"
                    },
                    {
                        ...
                        "description": "Filter survey scores by question IDs (repeatable)",
                        "name": "questionIds",
                        "in": "query"
                    }
                ],
        ...
        "/units/{unitId}/statistics/sla-heatmap": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "getUnitStatisticsSlaHeatmap",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "wait",
                        "description": "SLA type: wait or service",
                        "name": "type",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.SLAHeatmapResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/units/{unitId}/statistics/staff-performance": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "getUnitStatisticsStaffPerformanceList",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                    ...
                    },
                    {
                        ...
                        "description": "Sort field: ticketsCompleted|avgServiceMs|slaWait|csatAvg|utilizationPct",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.StaffPerformanceListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/units/{unitId}/statistics/staff-performance/{userId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "getUnitStatisticsStaffPerformanceDetail",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.StaffPerformanceResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/units/{unitId}/statistics/staffing-forecast": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "operationId": "getUnitStatisticsStaffingForecast",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subdivision unit ID",
                    ...
                    },
                    {
                        "type": "number",
                        "default": 90,
                        "description": "Target SLA percent, e.g. 90 (default)",
                        "name": "targetSlaPct",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "default": 5,
                        "description": "Target max wait time in minutes (default 5)",
                        "name": "targetMaxWaitMin",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "default": 4,
                        "description": "Number of past same-weekday samples (default 4)",
                        "name": "lookbackWeeks",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.StaffingForecastResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.VirtualQueueJoinRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.VirtualQueueJoinResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "403": {
                        "description": "Virtual queue not enabled for this unit",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable (kiosk frozen)",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "handlers.PlatformIntegrationsResponse": {
            ...
            "properties": {
                ...
                "smsApiKeyMasked": {
                    "description": "e.g. \"****abcd\" — last 4 chars only",
                    "type": "string"
                },
                "smsEnabled": {
                    "type": "boolean"
                ...
                "smsProvider": {
                    "description": "SMS integration (credentials are masked in read; never returned in plaintext).",
                    "type": "string"
                },
                "supportTrackerQueue": {
                    "type": "string"
        ...
        "handlers.QuotaExceededError": {
            ...
            "properties": {
                "error": {
                    "description": "Error is always \"quota_exceeded\".",
                    "type": "string",
                    "enum": [
                        "quota_exceeded"
                    ],
                ...
                "message": {
                    "type": "string",
                    "example": "unit quota exceeded for current subscription plan"
                },
                "metric": {
                    "type": "string",
                    "example": "units"
        ...
        "handlers.TestSMSIntegrationRequest": {
            "type": "object",
            "properties": {
                "phone": {
                    "description": "Phone number in E.164 format to send the test SMS to.",
                    "type": "string"
                }
            }
        },
        ...
        "handlers.VirtualQueueJoinRequest": {
            "type": "object",
            "properties": {
                "locale": {
                    "type": "string"
        ...
        "handlers.VirtualQueueJoinResponse": {
            "type": "object",
            "properties": {
                "ticket": {},
                "ticketPageUrl": {
        ...
        "handlers.bulkUpsertSkillsRequest": {
            "type": "object",
            "properties": {
                "skills": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.operatorSkillInput"
                    }
                }
            }
        },
        ...
        "models.Service": {
            ...
            "properties": {
                ...
                "duration": {
                    "description": "In seconds (expected / nominal service length for progress display)",
                    "type": "integer"
                },
                "gridCol": {
                    "type": "integer"
                ...
                "maxServiceTime": {
                    "description": "In seconds (service-time SLA — copied to Ticket.MaxServiceTime on in_service)",
                    "type": "integer"
                },
                "maxWaitingTime": {
                    "description": "In seconds (queue-wait SLA — copied to Ticket.MaxWaitingTime on create)",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "models.Ticket": {
            ...
            "properties": {
                ...
                "estimatedWaitSeconds": {
                    "description": "EstimatedWaitSeconds is the estimated seconds until this ticket is called (computed on-the-fly).",
                    "type": "integer"
                },
                "id": {
                    "type": "string"
                ...
                "maxServiceTime": {
                    "description": "Snapshot from Service at in_service; cleared on transfer/return",
                    "type": "integer"
                },
                "maxWaitingTime": {
                ...
                "queuePosition": {
                    "description": "QueuePosition is the 1-based position in the waiting queue (computed on-the-fly, not stored).",
                    "type": "integer"
                },
                "servedByName": {
                ...
                "servedByUserId": {
                    "description": "ServedByUserID is set when a ticket is called/picked; records the operator (counter.AssignedTo at call time).",
                    "type": "string"
                },
                "service": {
                    "$ref": "#/definitions/models.Service"
                ...
                "visitorToken": {
                    "description": "VisitorToken is a secret UUID issued at ticket creation. Visitor endpoints require it in\nthe X-Visitor-Token header to prevent IDOR on cancel and phone opt-in.",
                    "type": "string"
                }
            }
        },
        "models.Unit": {
            ...
            "properties": {
                ...
                "skillBasedRoutingEnabled": {
                    "description": "SkillBasedRoutingEnabled activates operator-service skill matching when calling the next ticket.\nWhen false (default) the system uses standard FIFO priority routing.",
                    "type": "boolean"
                },
                "slotConfig": {
                    "$ref": "#/definitions/models.SlotConfig"
        ...
        "models.UnitClient": {
            ...
            "properties": {
                ...
                "locale": {
                    "description": "Locale is the visitor's preferred locale (\"ru\" or \"en\"), set from the kiosk/virtual-queue on first phone identification.",
                    "type": "string"
                },
                "phoneE164": {
                    "type": "string"
        ...
        "services.DeploymentSaaSSettingsPatch": {
            ...
            "properties": {
                ...
                "smsApiKey": {
                    "description": "full credential (write-only; never returned in GET)",
                    "type": "string"
                },
                "smsApiSecret": {
                    "description": "full credential (write-only; never returned in GET)",
                ...
                "smsProvider": {
                    "description": "SMS provider settings (all optional).",
                    "type": "string"
                },
                "supportTrackerQueue": {
                    "type": "string"
        ...
        "services.HourlyStaffingForecast": {
            "type": "object",
            "properties": {
                "avgServiceTimeMin": {
                    "description": "avg handle time in minutes",
                    "type": "number"
                },
                "expectedArrivals": {
                    "description": "avg tickets expected this hour",
                    "type": "number"
                },
                "expectedSlaPct": {
                    "description": "Erlang C P(wait≤target) with recommended agents",
                    "type": "number"
                },
                "hour": {
                    "description": "0–23",
                ...
                "recommendedStaff": {
                    "description": "minimum agents to meet SLA",
                    "type": "integer"
                }
            }
        },
        ...
        "services.SLAHeatmapCell": {
            ...
            "properties": {
                ...
                "pct": {
                    "description": "0–100; 0 when total == 0",
                    "type": "number"
                },
                "total": {
                    "type": "integer"
        ...
        "services.SLAHeatmapResponse": {
            "type": "object",
            "properties": {
                "cells": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.SLAHeatmapCell"
                    }
                },
                "computedAt": {
                    "type": "string"
        ...
        "services.StaffPerformanceListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "services.StaffPerformanceResponse": {
            "type": "object",
            "properties": {
                "avgServiceMs": {
                    "type": "integer"
                ...
                "csatNorm": {
                    "description": "0–100, derived from csatAvg",
                    "type": "number"
                },
                "dailyTrend": {
                    "description": "Daily trend (only populated in detail mode)",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.StaffDailyTrendPoint"
                    }
                },
                "noShowCount": {
                    "type": "integer"
                ...
                "slaWait": {
                    "description": "Normalized radar axes (0–100)",
                    "type": "number"
                },
                "slaWaitMet": {
                    "type": "integer"
        ...
        "services.StaffingForecastResponse": {
            "type": "object",
            "properties": {
                "dailySummary": {
                    "$ref": "#/definitions/services.DailyStaffingSummary"
                },
                "dayOfWeek": {
                    "type": "string"
                },
                "hourlyForecasts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.HourlyStaffingForecast"
                    }
                },
                "targetDate": {
                    "type": "string"
        ...
        "services.UnitQueueSummary": {
            ...
            "properties": {
                ...
                "services": {
                    "description": "Services contains per-service breakdown when multiple services have waiting tickets.\nOmitted when only one service is active (redundant with the top-level fields).",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/services.ServiceQueueInfo"
                    }
                }
            }
        },

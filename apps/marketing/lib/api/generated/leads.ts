 ...
 */
import { marketingOrvalMutator } from '../../marketing-orval-mutator';
...
export type postPublicLeadRequestResponse503 = {
  data: string
  status: 503
}
...
export type postPublicLeadRequestResponse = (postPublicLeadRequestResponseSuccess | postPublicLeadRequestResponseError)

export const getPostPublicLeadRequestUrl = () => {




  return `/public/leads/request`
}

export const postPublicLeadRequest = async (handlersPublicLeadRequestBody: HandlersPublicLeadRequestBody, options?: RequestInit): Promise<postPublicLeadRequestResponse> => {

  return marketingOrvalMutator<postPublicLeadRequestResponse>(getPostPublicLeadRequestUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(
      handlersPublicLeadRequestBody,)
  }
);}
